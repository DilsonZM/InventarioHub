...
BEGIN
  ...
  LOOP
    ...
    v_cantidad_base := ROUND((v_item->>'cantidad')::DECIMAL)::INTEGER;
...
BEGIN
  ...
  IF p_tipo = 'entrada' THEN
    v_stock_nuevo := v_stock_actual + v_cantidad_int;
  ...
  INSERT INTO movimientos_inventario (
    ...
    p_producto_id, p_tipo, v_cantidad_int, v_stock_actual, v_stock_nuevo,
